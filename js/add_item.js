function addItem() {
    var formId = $(this).parent().attr('id');  // to get form's id value
    var count = 0;

    $('div#' + formId + ' > div').each(function () {
    ...
    $('<div class="form-check item-new">').insertBefore('#' + formId + ' > div:nth-last-child(2)');

    if ($(this).hasClass("add-field")) {

        if ($(this).parent().hasClass("radio-type")) {
            var inputId = formId + '_radio' + inputIndex;
            $('.item-new').append('<input class="form-check-input" type="radio" name="' + formId + '" id="' + inputId + '" value="#">');
            $('.item-new').append('<label class="form-check-label label-new" for="' + inputId + '"></label>');
            $('.label-new').append('<input type="text" class="form-control radio-input" id="input_' + formId + '" name="example" placeholder="Other">');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" style="margin: 10px 2px;" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/><path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/></svg>');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" style="margin: 10px 2px;" class="bi bi-trash delete-item" fill="red" xmlns="http://www.w3.org/2000/svg"> <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" /><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" /></svg>');
        }

        if ($(this).parent().hasClass("checkbox-type")) {
            var inputId = formId + '_check' + inputIndex;
            $('.item-new').append('<input class="form-check-input" type="checkbox" name="' + formId + '" id="' + inputId + '" value="#">');
            $('.item-new').append('<label class="form-check-label label-new" for="' + inputId + '"></label>');
            $('.label-new').append('<input type="text" class="form-control checkbox-input" id="input_' + formId + '" name="example" placeholder="Other">');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" style="margin: 10px 2px;" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/><path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/></svg>');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" style="margin: 10px 2px;" class="bi bi-trash delete-item" fill="red" xmlns="http://www.w3.org/2000/svg"> <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" /><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" /></svg>');
        }
        ...
        if ($(this).parent().hasClass("radio-type")) {
            var inputId = formId + '_radio' + inputIndex;
            $('.item-new').append('<input class="form-check-input" type="radio" name=' + formId + '" id="' + inputId + '">');
            $('.item-new').append('<label class="form-check-label label-new" for="' + inputId + '"><span class="option-en">New Item </span> | <span class="option-az">Yeni seçim</span></label>');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/><path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/></svg>');
        ...
        if ($(this).parent().hasClass("checkbox-type")) {
            var inputId = formId + '_check' + inputIndex;
            $('.item-new').append('<input class="form-check-input" type="checkbox" name=' + formId + '" id="' + inputId + '">');
            $('.item-new').append('<label class="form-check-label label-new" for="' + inputId + '"><span class="option-en">New Item </span> | <span class="option-az">Yeni seçim</span></label>');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z"/><path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/></svg>');
            $('.label-new').append('<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash delete-item" fill="red" xmlns="http://www.w3.org/2000/svg"> <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" /><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" /></svg>');
        }
    ...
    $("div").removeClass("item-new");
}

$(document).on('click', '.add-item', addItem);
$(document).on('click', '.add-field', addItem);

$(document).ready(function () {
    $(".checkbox-type").each(function () {
        $(this).append('<div class="add-item add-item-new"></div>');
    ...
    $(".checkbox-type, .radio-type").each(function () {
        $(this).append('<div class="add-field add-field-new"></div>');
